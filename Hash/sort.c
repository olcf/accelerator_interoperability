...
// needed for gpu math functions with pgi
#ifdef __PGI
  #include "accelmath.h"
#endif
 
// Forward declaration of nvcc compiled functions
void fill_rand(float *d_buffer, int num);
inline int hash_val(float x, float y, float z);
void sort(int *d_key, int *d_values, int num);
